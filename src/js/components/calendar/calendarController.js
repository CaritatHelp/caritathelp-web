'use strict';
module.exports = ['$stateParams', 'userService', 'DataVolunteers', 'DataAssociations', 'DataEvents',
	function ($stateParams, userService, DataVolunteers, DataAssociations, DataEvents) {
